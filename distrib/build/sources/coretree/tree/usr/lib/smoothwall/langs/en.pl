...
'destination port numbers' => 'Destination port must be a number.',
...
'ffc-comment' => 'Crontab comment:',
'ffc-enable rule' => 'Enable/Disable Rule',
'ffc-enabledc' => 'Enable',
'ffc-change-action-to' => 'Change Action To:',
'ffc-remove' => 'Remove Times',
'ffc-drop down menus' => 'Drop Down Menus',
'ffc-subnet check' => 'Subnet Check',
'day 7' => 'All',
'ffc-green' => '<font color=green>GREEN</font>:',
'ffc-orange' => '<font color=orange>ORANGE</font>:',
'ffc-purple' => '<font color=purple>PURPLE</font>:',
'ffc-action' => 'Action:',
'ffc-no days' => 'You must select a day or range of days!',
'ffc-start eq end' => 'Start time cannot equal end time!',
...
'ssadvanced' => 'advanced',
'ssexternal access' => 'external access',
'ssaliases' => 'multiple IPs',
'ssffc-timedaccess' => 'ffc timed access',
'ffc-current rules' => 'Current rules:',
...
'source ifacec' => 'Originating Source Interface:',
'source iface' => 'Source Interface',
'source ippfc' => 'Originating Source IP/Network or MAC:',
'source port or rangec' => 'Original Destination Port or Range:',
'source port' => 'Original destination port',
'destination ippfc' => 'New Destination IP or Network:',
'portfw source destination ip' => 'Leave blank for "Any"',
'destination ifacec' => 'New Destination Interface:',
...
'source ip bad purple' => 'Source IP/MAC is not within your PURPLE subnet',
...
'multi-ip device note' => '<B>Note:</B> The existing interfaces (RED GREEN etc.) appear in the following list for reference only.  They cannot be edited or removed here.',

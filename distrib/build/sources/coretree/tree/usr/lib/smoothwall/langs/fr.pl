...
'again' => 'A nouveau:',
'passwords must be at least 6 characters in length' => 'Les mots de passes doivent �tre d\'une longeur d\'au moins 6 caract�res',
'password contains illegal characters' => 'Le mot de passe contient les caract�res ill�gaux.',
...
'translation teams' => 'Les �quipes de traduction',
